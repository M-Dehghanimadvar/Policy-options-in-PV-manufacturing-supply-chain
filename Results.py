...
#                                        for Supplier in model.Supplier for month in
#                                        model.month)) / National_Demand
...
#     value(sum(
#         model.national_transportation_input_solar_backsheet[port, potential_manufacturer, transportation_type] *
